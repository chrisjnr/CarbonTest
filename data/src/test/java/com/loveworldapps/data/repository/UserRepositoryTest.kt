...
/**
 * Created by manuelchris-ogar on 28/03/2021.
 */
...
class UserRepositoryTest: BaseKoinTest(){
    ...
    val mAPIService : CarbonApi by inject()
    ...
    fun start(){
        ...
        mRepo = UserRepositoryImpl(userEntityMapper = userEntityMapper, carbonApi = mAPIService, db = testDb)
    ...
    fun `test that repo retrieves expected data`() {
        ...
        mRepo = UserRepositoryImpl(userEntityMapper = userEntityMapper, carbonApi = mAPIService, db = db)
