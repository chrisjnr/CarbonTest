package com.loveworldapps.carbontest.viewmodel

import androidx.lifecycle.*
import androidx.room.Room
import com.google.gson.GsonBuilder
import com.loveworldapps.carbontest.base.BaseTest
...
/**
 * Created by manuelchris-ogar on 28/01/2021.
 */
...
//    in-app test db
    ...
    private fun configureNetworkModuleForTest(baseApi: String)
        ...
        factory{ get<Retrofit>().create(CarbonApi::class.java) }
    }
